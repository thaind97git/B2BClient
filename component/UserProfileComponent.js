...
import { Descriptions, Row, Avatar, Col, Divider, Modal, Typography } from 'antd';
...
const UserProfileComponent = ({ isDrawer }) => {
  ...
  if (isDrawer) {
    return (
      <Row span={24}>
        ...
        <Col span={18}>
          <Descriptions title={USER_PROFILE.firstName + " " + USER_PROFILE.lastName} column={1}>
        ...
        <DescriptionItem title="Alternative Email" content={USER_PROFILE.alternativeEmail} />
        ...
        <DescriptionItem title="Certifications" content={USER_PROFILE.certifi} />
    ...
    <Form>
      ...
      <Descriptions title="Contact Information">
        ...
        <Descriptions.Item label="Telephone">{USER_PROFILE.telephone}</Descriptions.Item>
